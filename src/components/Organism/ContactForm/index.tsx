...
export default function ContactForm() {
  return (
    <section className="pb-20 px-4 bg-darker">
      <div className="container mx-auto max-w-6xl">
        <div className="grid md:grid-cols-2 gap-12">
          <div className="slide-in">
            <p className="text-gray-400">Got a project in mind?</p>
            <h2 className="text-3xl font-bold mb-4">Reserve a Call</h2>
          ...
          <div className="flex flex-col border border-lightRed rounded-md">
            <h4 className="p-4 border-b border-lightRed">Tell Us About Your Self</h4>
